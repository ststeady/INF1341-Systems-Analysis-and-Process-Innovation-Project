...
# open the output file as full screen to have better visualization
...
def getcuststd(country, start, end):
    ...
    return "The standard deviation of CO2 emission in " + country + " is " + str(custstd) + " from " + str(start) + " to " + str(end)


# Example run, comment out the ones you do not wish to run
...
print(whichbetter("Canada", "Japan", 2000))
